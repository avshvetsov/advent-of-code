...
class Day1Test {
    ...
    @ParameterizedTest
    @EnumSource(value = InputAnswer.class, names = {"DAY_1_PART_1.+"}, mode = EnumSource.Mode.MATCH_ALL)
    ...
    @ParameterizedTest
    @EnumSource(value = InputAnswer.class, names = {"DAY_1_PART_2.+"}, mode = EnumSource.Mode.MATCH_ALL)
