...
class Day7Test {
    ...
    @ParameterizedTest
    @EnumSource(value = InputAnswer.class, names = {"DAY_7_PART_1.+"}, mode = EnumSource.Mode.MATCH_ALL)
    public void partOneRecursionInput(InputAnswer param) {
        long result = day.partOneRecursion(Utils.parseInputByNewLine(param.getInput(PATH)));
        System.out.println(result);
        assertThat(result).isEqualTo(param.getAnswer());
    }
    ...
    @ParameterizedTest
    @EnumSource(value = InputAnswer.class, names = {"DAY_7_PART_1.+"}, mode = EnumSource.Mode.MATCH_ALL)
    public void partOneRecursionWithAccumulatorInput(InputAnswer param) {
        long result = day.partOneRecursionWithAccumulator(Utils.parseInputByNewLine(param.getInput(PATH)));
        System.out.println(result);
        assertThat(result).isEqualTo(param.getAnswer());
    }
